...
dag_3 = criar_dag(
    dag_id="clima_radar_precipitacao_15min",
    url="https://api.dados.rio/v2/clima_radar/precipitacao_15min/",
    schema="clima_radar",
    tabela="precipitacao_15min",
    descricao="Ingestão de dados de precipitação (15min).",
    tags=["precipitacao", "clima_radar"],
    schedule=None,
    start_date=datetime(2025, 4, 30)
)

dag_4 = criar_dag(
    dag_id="clima_radar_precipitacao_120min",
    url="https://api.dados.rio/v2/clima_radar/precipitacao_120min/",
    schema="clima_radar",
    tabela="precipitacao_120min",
    descricao="Ingestão de dados de precipitação (120min).",
    tags=["precipitacao", "clima_radar"],
    schedule=None,
    start_date=datetime(2025, 4, 30)
)
